...
class ViewController: UIViewController, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let myCell = collectionView.dequeueReusableCell(withReuseIdentifier: MyCollectionViewCell.myIndentifier, for: indexPath)
        return myCell
    }
    ...
    private lazy var myCollectionView: UICollectionView = {
        ...
        collection.register(MyCollectionViewCell.self, forCellWithReuseIdentifier: MyCollectionViewCell.myIndentifier)
        return collection
    }()
